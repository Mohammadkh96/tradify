  ...
  const emails: Array<{ subject: string; body: string }> = [
    ...
    },
    {
      ...
      body: `
        ...
        <p style="margin: 0 0 16px 0; font-size: 16px; color: #D1D5DB; line-height: 1.7;">This is the core principle behind TradifyApp. Not a journal. An enforcement layer.</p>
